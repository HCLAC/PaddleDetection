			...
			<scroll-view class="keyword-list-box" v-show="isShowKeywordList" scroll-y>
				<block v-for="(row,index) in keywordList" :key="index">
					<view class="keyword-entry" hover-class="keyword-entry-tap" >
						<view class="keyword-text" @tap.stop="doSearch(keywordList[index].keyword)" @click="Toresults">
...
<style>
	view{display:block;}
	.search-box {width:95%;background-color:rgb(255, 255, 255);padding:15upx 2.5%;display:flex;justify-content:space-between;position:sticky;top: 0;}
	...
	.search-bottom{font-size: 12px; color: #C0C0C0;margin-left: 15px;}
